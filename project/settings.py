...
MIDDLEWARE = [
    ...
    #'project.custom_middleware.NoCacheMiddleware',
...
EMAIL_USE_TLS = True  # or use SSL (EMAIL_USE_SSL = True) based on your email provider's requirements
